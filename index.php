                ...
                <div class="col-lg-5 wow fadeInRight" data-wow-delay=".5s">
                    ...
                    <div class="h1">
                        <div class="typed-strings">
                            <p><span class="id-color">Texnoloji Həllər İstehsal Edirik...</span></p>
                            <p><span class="id-color">Əylənərək öyrənirik...</span></p>
                            <p><span class="id-color">İşinizi görərkən Daha artığını Edərik...</span></p>
                        </div>
                        <div class="typed"></div>
                    </div>

                    <p class="lead">Sosial Media Marketing, Kataloq Dizaynı, Qablaşdırma Dizaynı,
                        Korporativ Eyniləşdirmə Kartı Dizaynı.</p>
                    <div class="spacer-20"></div>
                    <a class="btn-custom" href="about-us.php">Haqqımızda</a>&nbsp;
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="text-center">
                        <h3 style="font-size: 30px;">Media, İnformasiya və Texnologiya sahəsindəki xəyallarınızı
                            həyata keçirmək üçün istəkli bir ailəyik.</h3>
                        <h6>İlk öncə</h6>
                        <div class="spacer-20"></div>
                    </div>
                </div>
            ...
            <div class="row" style="margin-top: 90px;">
                <div class="col-lg-4 col-md-6 mb30 wow fadeInRight" data-wow-delay="0s">
                    <div class="f-box f-icon-left f-icon-rounded">
                        ...
                        <div class="fb-text">
                            <h4>Araşdırırıq</h4>
                            <p>xəyallarınızı xəyal edirik,</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb30 wow fadeInRight" data-wow-delay=".25s">
                    <div class="f-box f-icon-left f-icon-rounded">
                        ...
                        <div class="fb-text">
                            <h4>və sonra işi edirik..</h4>
                            <p>öz işimiz kimi düşünürük..</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 offset-md-1 wow fadeInLeft" data-wow-delay="0s">
                    <h2>Müştərilərimizin rəqiblərinə istinad edirik, lakin biz onları rəqib kimi görmürük.</h2>
                    <p class="lead">
                        Buta Qrup Media İnformasiya Texnologiyaları A.Ş. hərtərəfli bir İT qrupudur. Yaradıcı
                        heyət öz müştərilərinin bütün tələbatlarına A-dan Z-ə qədər xidmət edir. Bir korporativ
                        şirkətin korporativ şəxsiyyətinin qurulmasından başlayaraq sosial media, veb dizayn /
                        proqram təminatı, E-Ticarət, qrafik dizayn, marka qorunması və rəqəmsal marketinq kimi
                        sahələrdə işlər görməkdədir.
                    </p>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="de-image-hover rounded">
                        <a href="images/img/1.png" class="image-popup">
                            <span class="dih-title-wrap">
                                <span class="dih-title">Xülasə</span>
                            </span>
                ...
                <div class="col-lg-6 offset-lg-3 wow animated fadeInUp" data-wow-delay=".7s">
                    <div class="text-center">
                        <a class="btn-custom" href="works.php">Bütün işlərimiz</a>
                    </div>
                </div>
    ...
    <section id="section-banner" class="no-top" data-bgimage="url(images/background/3.png) top">
        <div class="container">
            <div class="row align-items-center">
                ...
                <h2 style="margin: auto;" class="wow animated fadeInUp" data-wow-delay=".9s">REFERANSLARIMIZ</h2>
                ...
                <div class="col-md-12 wow fadeInUp animated" data-wow-delay=".5s" style="margin-top: 100px;">
                    ...
                    <div style="text-align: center; margin-top: 100px;"> <a class="btn-custom" href="about-us.php">Bütün
